// Level: Turn
// Strategy: steer toward the acceleration needed to reach the target and slow
// down as the remaining distance shrinks.
function wrap(a) {
...
function goTo(q, stopRadius) {
  // Convert the desired position into a capped target velocity.
  var p = pos(),
    v = vel();
  var dx = q.x - p.x,
    dy = q.y - p.y;
