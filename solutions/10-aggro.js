// Level: Aggro
// Strategy: enter a tight powered spin so pursuing ships cluster around the
// player, then lead the lowest visible ship with laser fire.
function wrap(a) {
...
if (motion === 0) {
  ...
  // Spin up without thrust so the later orbit is repeatable.
  turn(1);
  thrust(0);
  if (vel().angular >= 0.08) {
    motion = 3;
